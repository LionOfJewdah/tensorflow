...
def get_tpu_strategy():
    resolver = tpu_cluster_resolver.TPUClusterResolver("local")
...
class TpuVmOutsideCompilationTest(test.TestCase, parameterized.TestCase):
    def setUp(self):
        super(TpuVmOutsideCompilationTest, self).setUp()
