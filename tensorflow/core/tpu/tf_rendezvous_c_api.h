...
#ifndef TENSORFLOW_CORE_TPU_TF_RENDEZVOUS_C_API_H_
#define TENSORFLOW_CORE_TPU_TF_RENDEZVOUS_C_API_H_
...
typedef struct TFTPU_AllocatorAttributes {
  uint32_t value;
  int32_t scope_id;
} TFTPU_AllocatorAttributes;
...
typedef struct TF_RendezvousArgsStruct {
  ...
  TFTPU_AllocatorAttributes alloc_attrs;
...
#endif  // TENSORFLOW_CORE_TPU_TF_RENDEZVOUS_C_API_H_
