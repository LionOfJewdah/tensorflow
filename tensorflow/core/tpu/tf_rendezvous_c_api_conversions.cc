...
TFTPU_AllocatorAttributes ToC(const tsl::AllocatorAttributes& attributes) {
  TFTPU_AllocatorAttributes c_attributes;
  c_attributes.value = attributes.value;
  c_attributes.scope_id = attributes.scope_id;
  return c_attributes;
}

tsl::AllocatorAttributes FromC(const TFTPU_AllocatorAttributes& c_attributes) {
...
void Destroy(TFTPU_AllocatorAttributes attributes) {}
